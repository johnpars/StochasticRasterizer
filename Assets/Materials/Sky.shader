Shader "StochasticRasterizer/Sky"
{
    Properties
    {
        [NoScaleOffset] _MainTex ("_MainTex (RGBA)", Cube) = "grey" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {             
                // Shade
                float3 c = SAMPLE_TEXTURECUBE_LOD(_MainTex, sampler_MainTex, i.vertexOS, 1).rgb;
